...
skater_game_ID = []; skater_playerID = []; skater_sweaterNumber = []; skater_position = []
goalie_game_ID = []; goalie_playerID = []; goalie_sweaterNumber = []; goalie_position = []
goals = []; assists = []; points = []; plusMinus = []
skater_pim = []; goalie_pim = []; hits = []; powerPlayGoals = []
sog = []; faceoffWinningPctg = []; skater_toi = []; goalie_toi = []
...
powerPlayGoalsAgainst = []; shorthandedGoalsAgainst = []; goalsAgainst = []
starter = []; shotsAgainst = []; saves = []
