    ...
    <div class="bg-dark text-white text-center">
        ...
        <form method="GET" action="nhlSQLconnector.php">
            <select name="search_column">
                ...
                <option value="visitingTeamId">Away Team</option>
            </select>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "GET") {
            ...
            while ($row = $result->fetch_assoc()){
                ...
                # Home Team
                // echo "<td>".$row['home_team_tricode']."</td>";
                if ($row['homeScore']>$row['visitingScore']) {
                ...
                # Visiting Team
                // echo "<td>".$row['visiting_team_tricode']."</td>";
                if ($row['homeScore']<$row['visitingScore']) {
                    echo "<td style='font-weight: bold'>".$row['visiting_team_name']."</td>";
                    echo "<td style='font-weight: bold'>".$row['visitingScore']."</td>";
                } else {
                    echo "<td>".$row['visiting_team_name']."</td>";
